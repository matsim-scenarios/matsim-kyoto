...
public class GtfsConverterKyoto {
    ...
    private GtfsConverterKyoto(Builder builder) {
    ...
    public static final class Builder {
         ...
         */
        public GtfsConverterKyoto build() {
            return new GtfsConverterKyoto(this);
        }
         ...
         */
        public Builder setFeed(Path feedPath) {
            this.feed = GTFSFeed.fromFile(feedPath.toString());
